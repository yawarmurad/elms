...
?>
    ...
    <head>
        ...
        <title>ELM | Apply Leave</title>
        <link rel="shortcut icon" type="image/png" href="../assets/images/icon/favicon-32x32.png">
                            ...
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <div class="breadcrumbs-area clearfix">
                                        <h4 class="page-title pull-left">Apply For Leave</h4>
                                            ...
                                            <div class="card">
                                                <form name="addemp" method="POST">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <button class="btn btn-primary float-right mb-4" name="apply" id="apply" type="submit">SUBMIT</button>
