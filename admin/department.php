...
?>
    ...
    <head>
        ...
        <title>EMS Admin - Department</title>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="data-tables datatable-dark">
                                        <a href="add-department.php" class="btn btn-sm btn-info mb-4">Add New Department</a>
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) {               ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="edit-department.php?deptid=<?php echo htmlentities($result->id); ?>"><i class="fa fa-edit fa-lg mr-4" style="color:green"></i></a><a href="department.php?del=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Do you want to delete');"> <i class="fa fa-trash fa-lg" style="color:red"></i></a></td>
                                                        </tr>
                                                <?php $cnt++;
                                                    }
                                                } ?>
