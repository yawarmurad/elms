                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <p class="text-muted fw-medium">Leave Types</p>
                                                <h1 class="mb-0"><?php include 'counters/leavetype-counter.php' ?></h1>
                                            </div>

                                            <div class="flex-shrink-0 align-self-center">
                                                <div class="mini-stat-icon ">
                                                    <span class="avatar-title">
                                                        <i class="fa fa-sign-out db-icon" aria-hidden="true"></i>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                ...
                                                <h1 class="mb-0"><?php include 'counters/emp-counter.php' ?></h1>
                                            </div>

                                            <div class="flex-shrink-0 align-self-center">
                                                <div class="mini-stat-icon ">
                                                    <span class="avatar-title">
                                                        <i class="fa fa-users db-icon" aria-hidden="true"></i>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-shrink-0 align-self-center">
                                                <div class="mini-stat-icon ">
                                                    <span class="avatar-title">
                                                        <i class="fa fa-university db-icon" aria-hidden="true"></i>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <p class="text-muted fw-medium">Pendig Leave</p>
                                            ...
                                            <div class="flex-shrink-0 align-self-center">
                                                <div class="mini-stat-icon ">
                                                    <span class="avatar-title">
                                                        <i class="fa fa-spinner db-icon" aria-hidden="true"></i>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <p class="text-muted fw-medium">Declined Leave</p>
                                            ...
                                            <div class="flex-shrink-0 align-self-center">
                                                <div class="mini-stat-icon ">
                                                    <span class="avatar-title">
                                                        <i class="fa fa-times py-2 db-icon" aria-hidden="true"></i> </span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <p class="text-muted fw-medium">Approved Leave</p>
                                            ...
                                            <div class="flex-shrink-0 align-self-center">
                                                <div class="mini-stat-icon ">
                                                    <span class="avatar-title">
                                                        <i class="fa fa-check db-icon" aria-hidden="true"></i>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="single-table">
                                        <div class="table-responsive">
                                            <table class="table table-hover table-bordered table-striped progress-table">
                                                <thead>
                                                    ...
                                                    ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php $stats = $result->Status;
                                                                    ...
                                                                    <?php }
                                                                    if ($stats == 2) { ?>
                                                                        <span class="badge badge-danger">Declined</i></span>
                                                                    <?php }
                                                                    if ($stats == 0) { ?>
                                                                        <span class="badge badge-info">Pending</i></span>
                                                                    <?php } ?>
