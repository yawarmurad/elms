                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    <td colspan="12">
                                                                        <button type="button" class="btn btn-success float-right" data-toggle="modal" data-target="#exampleModal">Set Action</button>
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <form method="POST" name="adminaction">
                                                                                        ...
                                                                                        <div class="modal-footer">
                                                                                            ...
                                                                                            <button type="submit" class="btn btn-success btn-sm" name="update">Apply</button>
                                                                                        </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
