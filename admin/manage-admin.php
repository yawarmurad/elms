...
?>
    ...
    <head>
        ...
        <title>EMS Admin | Manage Admin</title>
                        ...
                        <div class="col-12 mt-5">
                            ...
                            <div class="card-body">
                                <div class="data-tables datatable-dark">
                                    <a href="add-admin.php" class="btn btn-sm btn-info mb-4">Add New Administrator</a>
                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $result) {               ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="manage-admin.php?del=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Do you want to delete');"> <i class="fa fa-trash fa-lg" style="color:red"></i></a></td>
                                                    </tr>
                                            <?php $cnt++;
                                                }
                                            } ?>
